...
function displayPics(){
  ...
  // The deleted line tried to reference rando from the global scope, which threw a ReferenceError. The problem was that rando is declared using `let` in displayPics which limits its scope to that function.
